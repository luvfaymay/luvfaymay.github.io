    ...
    <section id="five" class="spotlights">
        ...
        <section>
            ...
            <div class="content">
                <div class="inner">
                    <header class="major">
                        <h3>{{ site.translations[site.lang].fan_projects.faymay_ch_fm.title }}</h3>
                    </header>
                    <p>{{ site.translations[site.lang].fan_projects.faymay_ch_fm.description }}</p>
                    <p>{{ site.translations[site.lang].fan_projects.faymay_ch_fm.check_post }} <span class="vote-link"><a href="https://x.com/Gackyccc_/status/1836948529648128004">{{ site.translations[site.lang].fan_projects.faymay_ch_fm.full_post }}</a></span></p>
                </div>
            </div>
        </section>
        <section>
